sample_1='s21 Co(NO3)2 6H2O'
sample_2='s22 Co2FeO4'
sample_3='s23 Co2.5Fe0.5O4'
...
scan.continuous(detector.eiger(), det_exposure=2, sample_exposure=0.5, X0=18500, X1=19000, dX=700, Y0=0, Y1=8100, passes=10, sample='Co(OH)2', linedelay=0)

#Measurement
print("########## MEASUREMENT ##########")
#1
scan.continuous(detector.eiger(), det_exposure=5, sample_exposure=0.5, X0=36700, X1=39000, dX=750, Y0=-7700, Y1=8100, passes=6, sample=sample_1, linedelay=0)
#2
scan.continuous(detector.eiger(), det_exposure=5, sample_exposure=0.5, X0=2600, X1=5000, dX=750, Y0=-7700, Y1=8100, passes=6, sample=sample_2, linedelay=0)
#3
scan.continuous(detector.eiger(), det_exposure=5, sample_exposure=0.5, X0=-15200, X1=-12500, dX=750, Y0=-7700, Y1=8100, passes=6, sample=sample_3, linedelay=0)
