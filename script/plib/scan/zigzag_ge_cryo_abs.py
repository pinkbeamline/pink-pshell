            ...
            while pass_id <= passes:
                ...
                for line_id in range(int(Xpoints)):
                    ...
                    for point_id in range(int(Ypoints)):
                        ...
                        #append_dataset("passes/"+passpath+"/detector/eigerccd/processed/image", Convert.reshape(Eiger_roi_array.take(), Eiger_ROI_Y, Eiger_ROI_X))
                        ...
                        append_dataset("passes/"+passpath+"/positioners/pos_abs_x", cryo_x_RBV.take())
                        append_dataset("passes/"+passpath+"/positioners/pos_abs_y", cryo_y_RBV.take())
