            ...
            while pass_id <= passes:
                ...
                for xpos in x_positions:
                    ...
                    for point_id in range(int(Ypoints)):
                        ...
                        #sposxarr = array('d',sposx)
                        #append_dataset("passes/"+passpath+"/positioners/sec_el_x", sposxarr)
                        #sposy[1]=Sec_el_y_RBV.take()
                        #sposyarr = array('d',sposy)
                        #append_dataset("passes/"+passpath+"/positioners/sec_el_y", spoxyarr)
